<x-layout-users>
    ...
    <div class="flex flex-col flex-1 min-h-screen mesh-bg relative overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 flex-1 flex flex-col absen-page-wrapper">
            ...
            {{-- ALERT MESSAGES --}}
            @if(session('success'))
                <div class="bg-green-500/10 backdrop-blur-md border border-green-200/50 text-green-700 p-4 rounded-xl mb-4 font-semibold text-sm flex items-center gap-2" role="alert">
                    <i class="fas fa-check-circle"></i>
                    {{ session('success') }}
                </div>
            @endif
            @if(session('error'))
                <div class="bg-red-500/10 backdrop-blur-md border border-red-200/50 text-red-700 p-4 rounded-xl mb-4 font-semibold text-sm flex items-center gap-2" role="alert">
