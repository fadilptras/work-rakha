<x-layout-users>
    ...
    <style>
        ...
        .fc .fc-daygrid-day:not(.fc-day-other):hover .fc-daygrid-day-number {
        ...
        .fc .fc-daygrid-day-events {
            margin-top: 4px;
            /* Beri jarak dari angka tanggal */
            width: 100%;
            padding: 0 4px;
            /* Beri sedikit padding horizontal */
        }
        ...
        .fc-daygrid-event {
            ...
            /* Rapikan margin, hanya atas-bawah */
        ...
        .fc .fc-daygrid-more-link {
            color: #4338ca;
            font-size: 0.7rem;
            /* Samakan font size dengan agenda */
            font-weight: 600;
        ...
        .fc-daygrid-event.holiday-event {
            ...
            /* Kembalikan ke warna asli merah/oranye */
            border: none !important;
            /* Hilangkan border abu-abu */
        ...
        .weekly-strip .week-nav-btn:hover {
            background: #dbeafe;
            color: #1d4ed8;
        }
        ...
        .weekly-strip .day-num.today.has-event::after {
            background: #fff;
        }
        ...
        .absensi-btn-mobile.active-btn i {
            color: #fff;
        }
        ...
        .absensi-btn-mobile.active-btn .btn-icon {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const agendaDate = flatpickr("#agenda_date", {
                dateFormat: "Y-m-d",
                altInput: true,
                altFormat: "d F Y",
                locale: "id"
            });
            const startHour = flatpickr("#start_hour", {
                enableTime: true,
                noCalendar: true,
                dateFormat: "H:i",
                time_24hr: true
            });
            const endHour = flatpickr("#end_hour", {
                enableTime: true,
                noCalendar: true,
                dateFormat: "H:i",
                time_24hr: true
            ...
            function updateAgendaList(selectedDate) {
                ...
                const startFormatted = startOfWeek.toLocaleDateString('id-ID', {
                    day: 'numeric',
                    month: 'short'
                });
                const endFormatted = endOfWeek.toLocaleDateString('id-ID', {
                    day: 'numeric',
                    month: 'short'
                });
