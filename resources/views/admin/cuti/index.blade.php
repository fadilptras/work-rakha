                    ...
                    <tr class="hover:bg-zinc-700/50 transition group">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                {{-- Tombol Hapus --}}
                                <form action="{{ route('admin.cuti.destroy', $cuti->id) }}" method="POST" onsubmit="confirmSubmit(event, 'Apakah Anda yakin ingin menghapus data cuti ini? Tindakan ini tidak dapat dibatalkan.');">
                                    @csrf
                                    @method('DELETE')
