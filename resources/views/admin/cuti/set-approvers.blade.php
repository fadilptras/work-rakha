    ...
    <div>
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <div>
                ...
                <p class="text-sm text-zinc-400 mt-1">Mengatur urutan persetujuan (Approver 1 hingga 4) untuk pengajuan cuti karyawan.</p>
            </div>
        </div>
                        ...
                        <tbody class="divide-y divide-zinc-700">
                            @forelse ($employees as $employee)
                                <tr class="hover:bg-zinc-700/50 approver-row">
                                    ...
                                    {{-- Kolom 4 Khusus (Admin Rakha Boleh Masuk via $admins) --}}
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <div class="relative w-full min-w-[150px] max-w-[180px]">
                                            <div class="absolute inset-y-0 right-3 flex items-center pointer-events-none">
                                                <i class="fas fa-chevron-down text-[9px] text-zinc-400"></i>
