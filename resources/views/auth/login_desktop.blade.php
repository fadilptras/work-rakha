...
<head>
  ...
  <link rel="manifest" href="{{ asset('login.webmanifest') }}?v=4">
...
<body class="text-gray-800 relative min-h-screen flex items-center justify-center overflow-hidden">
  ...
  <div class="w-full max-w-4xl flex flex-row rounded-2xl shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] bg-white/90 backdrop-blur-2xl border border-white/50 overflow-hidden z-10 relative">
    
    <div class="w-1/2 bg-gradient-to-br from-sky-500 to-sky-700 flex items-center justify-center p-12 relative overflow-hidden">
    ...
    <div class="w-1/2 bg-transparent flex flex-col justify-center p-12">
      
      <div class="text-left mb-8">
          <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Sign In</h1>
          <p class="mt-2 text-sm text-gray-500 font-medium">Silakan masuk untuk melanjutkan</p>
      </div>
