...
return new class extends Migration
{
    ...
    {
        // === TABEL USERS ===
        // Pengecekan hasColumn agar migration idempoten (aman dijalankan ulang)
        // jika kolom sudah ada sebelumnya (misal dari fix_db.php yg pernah dijalankan)
        Schema::table('users', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('users', 'approver_dana_4_id')) {
