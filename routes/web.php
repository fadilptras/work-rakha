...
Route::controller(SalesController::class)->prefix('sales')->name('sales.')->group(function () {
    ...
    Route::post('/stock/add-barang', [StockController::class, 'addBarang'])->name('stock.add_barang');
    Route::post('/stock/parse-import', [StockController::class, 'parseImport'])->name('stock.parse_import');
    Route::post('/stock/save-import', [StockController::class, 'saveImport'])->name('stock.save_import');
